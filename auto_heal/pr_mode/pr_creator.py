...
This is the *only* place auto-heal turns local changes into something visible
...
from auto_heal.pr_mode.self_grow_guard import GuardDecision
...
class PrCreatorConfig:
    ...
    default_labels: tuple[str, ...] = ("auto-heal",)
...
class PrCreator:
    ...
    def open_pr(
        ...
        *,
        ...
        body_path = worktree.path / ".auto-heal-pr-body.md"
