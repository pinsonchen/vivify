...
from auto_heal.agents.prompts import builders
from auto_heal.agents.prompts.parsers import _FENCED_JSON_RE  # type: ignore[attr-defined]
from auto_heal.goals.differ import is_duplicate
...
from auto_heal.models.feature import FeatureRequest, FeatureSpec, Goal
from auto_heal.models.snapshot import KpiSnapshot
