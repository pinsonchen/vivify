...
``/tmp/channels-monitor/auto_heal/feature_dev.py`` but stripped of business
...
from auto_heal.models.snapshot import ActionLog, KnowledgeEntry
from auto_heal.pr_mode.auto_merge import AutoMerge
from auto_heal.pr_mode.pr_creator import PrCreator, PullRequest
...
class FeaturePipeline:
    ...
    def _render_pr_body(
        ...
        *,
        ...
        return (
            f"## auto-heal feature #{feature.id}: {feature.title}\n\n"
