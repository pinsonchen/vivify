...
:meth:`CodingAgent.heal`. They sit on top of :mod:`auto_heal.agents.prompts.snippets`
...
from auto_heal.agents.prompts import snippets
from auto_heal.models import FeatureRequest, Goal, Issue
